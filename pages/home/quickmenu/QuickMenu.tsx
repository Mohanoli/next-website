  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          {/* Toggle Tab */}
          <div className="flex flex-col items-center justify-center gap-1 w-6 h-30 rounded-l-xl bg-[#077430] dark:bg-[#d6a606] text-white shadow-xl shrink-0">
          ...
          >
            <div
  className="
    flex flex-col py-2 px-1 gap-1
    bg-linear-to-b
    from-[#065f2e] to-[#043d1d]
